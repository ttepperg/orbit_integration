...
dataDir = "./output/"
# dataFile = "orbit_int_kepler_2d_rk4.dat"
# dataFile = "orbit_int_kepler_2d_leap.dat"
dataFile = "orbit_int_kepler_2d_leap_phys.dat"
...
unset label
set label sprintf("T = %5.3f %s", i*timeUnit*timeStep,timeUnitName) at first -0.9*plotRange,0.9*plotRange
pl dataDir.dataFile u ($4):($0 <= i ? $6 : 1/0) w l t "orbit", \
'' u ($4):($0 == i ? $6 : 1/0) w p pt 7 ps 2 t "body", \
'' u ($4):($0 == i ? $6 : 1/0):(velVectorScale*$5):(velVectorScale*$7) w vectors t "velocity", \
