...
This set of parameters is essentially identical to m31_m33_infall_vandermarel_gaia_hst.py,
but taking dynamical friction into account. See m31_m33_infall_vandermarel_gaia_hst.py for
more information.
