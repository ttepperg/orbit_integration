...
mac-ina:two_body tepper$ py37 two_body_orbit.py mw_bar_sgr_point_10kpc_fwd.py
...
Gathering input parameters from file mw_bar_sgr_point_10kpc_fwd...
Done.
...
Initial (osculating) orbital parameters of the system:
          ...
          Initial rel. distance (r21_0):        18.8340
             Initial rel. speed (v21_0):       181.7521
      Initial tangential vel. (v_tan_0):       175.2151
          Initial radial vel. (v_rad_0):       -48.3062
   Rel. specific ang. mom. vec. (h_vec): (0.000,-3300.000,0.000)
                           [normalised]: (0.000,-1.000,0.000)
                         [along z-axis]: (0.000,-0.000,3300.000)
            Rel. specific ang. mom. (h):      3300.0005

                       Eccentricity (e):         0.5416
                  Semi-latus rectum (p):         8.9359
                     Semimajor axis (a):        12.6447
                     Semiminor axis (b):        10.6297
       Orbital inclination (psi_0; deg):        90.0000
                 Ascending node (n_vec): (3300.000,0.000,-0.000)
      Long. of asc. node (Omega_0; deg):         0.0000
            Eccentricity vector (e_vec): (-0.265,0.000,-0.473)
             Apsidal angle (phi_0; deg):      -119.2482
   Argument of periapsis (omega_0; deg):       240.7518
                   Rel. pericentre (rp):         5.7966
                Vel. at pericentre (vp):       569.3010
                    Rel. apocentre (ra):        19.4927
                 Vel. at apocentre (va):       169.2938
                Rel. orbital period (T):         0.2559
        Approx. orbit circumference (u):        73.2557
        Approx. pericentric period (Tp):         0.1287
     Rel. specific potential energy (V):    -2.2148E+05
       Rel. specific kinetic energy (T):     1.6517E+04
...
x2_0, y2_0, z2_0 = 4.96075,0.00000,18.16894
vx2_0, vy2_0, vz2_0 = -181.75153,-0.00000,-0.44997
